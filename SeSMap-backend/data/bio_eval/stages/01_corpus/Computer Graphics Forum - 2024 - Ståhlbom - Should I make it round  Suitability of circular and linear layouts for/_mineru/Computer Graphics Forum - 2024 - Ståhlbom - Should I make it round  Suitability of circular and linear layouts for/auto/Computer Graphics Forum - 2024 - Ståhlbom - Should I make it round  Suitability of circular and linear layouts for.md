...
The presented work is a foundational part of our visualization research agenda in genomics. This domain is nicely mapped by the survey and taxonomy definition provided by Nusrat et al. [NHG19]. Of particular relevance is their proposed genomics visualization layout categories: linear, circular, space-filling, and spatial. Drilling down further, the arrangement within the plots can be categorized as parallel, serial, or orthogonal.

A key resource for genomics visualization designers is the Gosling visualization framework [LWLG22], which we have employed as our main prototyping tool. There are many examples of proposed visualization solutions for specific genomics analysis tasks (e.g., [vdBJvW<sup>∗</sup>23,LKD<sup>∗</sup>23,RFT<sup>∗</sup>13,FNM13,RZZ<sup>∗</sup>13]), as well as explorations of the genomics visualization design space [LG22, PLW<sup>∗</sup>22].

A tool of particular importance for our work is the plotting tool Circos created by Krzywinski et al. [KSB<sup>∗</sup>09]. Circos is popular in genomics publications [GET<sup>∗</sup>13, HHA<sup>∗</sup>09, DSX<sup>∗</sup>23] but also utilized in other domains such as transportation and migration [ZFAQ13, Sti17]. It primarily targets visualization of variation in genomic structure and relationships between genomic intervals and is presented as a tool for rapid deployment in data analysis and reporting.

The suitability of circular and linear plots in genomics has been discussed previously. The software GenoRec [PLW<sup>∗</sup>22] recommends visualizations for genomics data using a rule-based recommendation scheme. The authors recommend both linear and circular layouts for overview tasks searching for trends or patterns. There are indications that circular plots do not work well for tasks requiring zooming and panning. Moreover, for comparisons of length and position, the authors conclude that circular layouts are not useful citing Waldner et al. [WDG 20]. However, the relevance of the Waldner et al. study for genomics can be questioned, as it targets temporal (and thus cyclical) data and primarily focuses on rose charts, which is not what is typically used in genomics contexts. The circular layouts in genomics data are typically one or more tracks arranged in parallel or serially, often with interconnections running through the circle’s center [NHG19], creating a chord diagram.

Outside of genomics-specific work, circular visualizations [DLR09] (also called radial) have attracted substantial research attention. Radial charts are often used for temporal data, due to their cyclical nature [WDG<sup>∗</sup>20, BCPR22, CDBM22, MM18, BLIC19, BW14].

Some previous efforts have compared the two layouts, from different angles. One example is a comparison of smartwatch visualization designs [BBB<sup>∗</sup>19] for regular bar charts, donut charts, and radial bar charts, finding that the radial visualization performed the worst. Performance of an area estimation task has been shown to be similar for circles and rectangles [HB10]. Goldberg and Helfman [GH11] evaluated linear versus radial bar, line, area, and scatterplots, outlining how scanning patterns differed and recommended that not too many concentric rings be used in a radial graph due to risk of confusion. Further details on these insights were made in the genomics setting: when adding more tracks to a circular layout the individual tracks become very small and if tracks are long part of the circle ends up out of the viewport [LG22].
...
![](images/44b7a9036bcfebb2968a59e03de6cfddc51af4878c5b48a54199d4a8f7028318.jpg)  
Figure 2: Datapoints and missing values from the study sessions.

![](images/8b486a16ac71b1d7522e9b1af15c4e1d17e0ffebf6defd6cf3ba91e84bd0ceb3.jpg)  
Figure 3: Contamination ofone sample by another. Thisfigure was used to introduce the contamination task, explaining how processing multiple samples in parallel can lead to contamination events.
...
One of the experiment tasks simulated detection of contamination events, which is a quality control step in some genomics labs.

![](images/60e8bb1b7878431b5df24c921d5d1d58c853cce2d0cd57cbec20d69d0be4d96b.jpg)  
Figure 4: The genomic variants ofone sample shown in a circular and a linear layout. Genomic variants are indicated by the purple bars, with opacity encodingfor concentration.

As multiple samples are typically processed in parallel, spilling or other mistakes can lead to one sample contaminating another (see Figure 3). In the event of a contamination, the genomic variants from the contaminating sample will also occur in the contaminated sample, but at a lower concentration.
...
![](images/5b6470e03005591e8e477334a4a95df4baeccf0cafedc8a5f3ec2aaaff14a8c3.jpg)  
Figure 5: Variantsfrom multiple samples stacked in a circular layout. A contamination can be seen between two samples whichfor illustration purposes here are denoted by the arrows.

![](images/bdf837907f3fabd8a9bf0b2964c8800f48c43537dd83093111ab16d12a8fc77d.jpg)  
...
![](images/860b3546ed6f0a5f8ed0b4861a18f456dfde0a63e0140d15dddece748aea4021.jpg)  
Samples are generated Variant concentrations are drawn from a uniform distribution from 0 to 100.

![](images/c5e139f42281e01c63e132e1115b085e877e67c08596d52f7f514d51480fe905.jpg)  
For each sample a mask is generated Positions to remove are drawn from a uniform distribution.

![](images/8ab810981c08395704983734b170c40252ff85bb554bf713f3fafe47b413393a.jpg)  
Calculation of a contaminated sample

Only variants that occur exactly two times are kept  
![](images/8f53e5eed67ee61d13720926541fa550688314c737f7fd9a958aacc928c771c5.jpg)  
Figure 7: The data generation process for the contamination detection task. Shades of purple represent variant concentration, with white denoting full absence. Masks are in black (value 1) and white (value 0).

![](images/6d7ee467a915b6eaf56928d1ca6e3fea859b801cf8040e3026c682a4f895fb72.jpg)  
...
![](images/12bcc590f8d1129e20124aeaf4771cc4d4ddd76e0bd81da9251de7121ac7eecf.jpg)  
Figure 9: The circular layoutfor the connective data as visualized in the user study. Chromosomes span the outer rim.

## 3.7. User study participants

Participants were recruited from one IT company and one university division, with a majority working in software development or visualization research. Though the tasks were inspired by genomics, the underlying tasks can be performed on data from other domains. By sampling a population that was not geneticists, we strengthen the claim to generalization outside of genomics. We also opted for non-geneticists since that allowed us to recruit more participants to the study within a shorter time frame, strengthening the statistical power of the results. Finally, participants’ unfamiliarity with the subject allowed us to introduce the data and task with minimal previous knowledge of the domain influencing their mental model, which might not have been the case for domain experts.

![](images/63867842ee58f4a66ca1c9500ffef914b074e4c51cff8c2e9588d1839cc0bfa3.jpg)  
...
For the contamination detection task, the mean accuracy was 0.690 for the circular layout and 0.851 for the linear layout. The difference was statistically significant $( \chi ^ { 2 } ( 1 ) = 6 . 8 6 , p < . 0 5 )$ . For the interactions task, the mean accuracy was 0.792 for the circular layout and 0.764 for the linear layout, with no statistical significance. The mean completion time for the contamination detection task was 45.7 seconds for the circular layout and 37.0 seconds for the linear layout, with no statistical significance. For the interactions task the mean completion time was 41.3 seconds for the circular layout and 34.5 seconds for the linear layout. The difference was not statistically significant. The estimated difference in intercept from a model including conditions and a model without conditions are displayed in Figure 12. The 95% confidence intervals are plotted along with the point estimates.

![](images/227b27935f5abd8792588127014596fa028fa709fad8f2c633bb75d3820debf8.jpg)

![](images/0347fc011bcc3bf8acfb2fcf55085935a869ede51d0538ea6084c1ee78ff2d15.jpg)  
Figure 11: Mean task completion time and mean accuracy. There is a clear difference in accuracy between the conditionsfor the contamination detection task and a trend towards linear layouts resulting in shorter completion times.

![](images/0d1bbb2ec9824ce07268409cf2d4e816a2d37bdf08ab025fea237b1b112f5b0c.jpg)

![](images/4f7f02e0d047577d3e13e47ec1d5ac71c1417f27ebd7854e20663791138e5761.jpg)

![](images/0951f3f66a4203850a44886131ca975be98ae06209bcf12cf39e2e19e4569afb.jpg)  
Figure 12: Point estimations and 95%-confidence intervalsfor the difference between linear and circular layouts in accuracy and time spent on each case. The contamination detection has a higher accuracy value for linear representations, leading to a difference in accuracy that is above zero. For the time spent on each task, both point estimates indicate a slightlyfaster completion timefor linear layouts, but the results are inconclusive.
...
![](images/542c5dfa917da0761f40fe9fffd4e09f0ddee690d4d49887b5de64f1ea56fc2f.jpg)  
Figure 13: Answers to the post-study questionnaire. There are two missing datapoints in the second and third row respectively due to responses missing. Alternatives selected by no participant are omittedfrom the color scale.
...
## 4.3. System improvement feedback
...
[AA06] ANDRIENKO N., ANDRIENKO G.: Exploratory Analysis of Spatial and Temporal Data: A Systematic Approach. Springer Berlin Heidelberg, Berlin, Heidelberg, 2006, pp. 47–161. doi:10.1007/ 3-540-31190-4\_3. 2, 4

[BBB<sup>∗</sup>19] BLASCHECK T., BESANÇON L., BEZERIANOS A., LEE B., ISENBERG P.: Glanceable visualization: Studies of data comparison performance on smartwatches. 630–640. doi:10.1109/TVCG.2018. 2865142. 2, 9

[BCPR22] BASTARDO R., CASTRO M., PAVÃO J., RAMOS L.: A timeline model for clinical events: empowering data. 1053–1058. doi: 10.1016/j.procs.2021.12.109. 2

[BLIC19] BREHMER M., LEE B., ISENBERG P., CHOE E. K.: Visualizing ranges over time on mobile phones: A task-based crowdsourced evaluation. 619–629. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10.1109/TVCG.2018.2865234. 2

[BM13] BREHMER M., MUNZNER T.: A multi-level typology of abstract visualization tasks. IEEE Transactions on Visualization and Computer Graphics 19 (12 2013), 2376–85. doi:10.1109/TVCG.2013.124. 2

[BW14] BURCH M., WEISKOPF D.: On the benefits and drawbacks of radial diagrams. In Handbook of Human Centric Visualization, Huang W., (Ed.). Springer, 2014, pp. 429–451. doi:10.1007/ 978-1-4614-7485-2\_17. 2

[CDBM22] CHEN K.-T., DWYER T., BACH B., MARRIOTT K.: Rotate or wrap? interactive visualisations of cyclical data on cylindrical or toroidal topologies. 727–736. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10.1109/TVCG.2021. 3114693. 2

[DBB10] DIEHL S., BECK F., BURCH M.: Uncovering strengths and weaknesses of radial visualizations—an empirical approach. 935–942. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10.1109/TVCG.2010.209. 2, 9, 10

[DLR09] DRAPER G., LIVNAT Y., RIESENFELD R.: A survey of radial methods for information visualization. 759–776. doi:10.1109/ TVCG.2009.23. 2

[DSX<sup>∗</sup>23] DIESH C., STEVENS G. J., XIE P., DE JESUS MARTINEZ T., HERSHBERG E. A., LEUNG A., GUO E., DIDER S., ZHANG J., BRIDGE C., HOGUE G., DUNCAN A., MORGAN M., FLORES T., BIM-BER B. N., HAW R., CAIN S., BUELS R. M., STEIN L. D., HOLMES I. H.: JBrowse 2: a modular genome browser with views of synteny and structural variation. 1–21. Number: 1 Publisher: BioMed Central. doi:10.1186/s13059-023-02914-z. 2

[FNM13] FERSTAY J. A., NIELSEN C. B., MUNZNER T.: Variant view: visualizing sequence variants in their gene context. 2546–2555. doi: 10.1109/TVCG.2013.214. 2

[GET<sup>∗</sup>13] GOECKS J., EBERHARD C., TOO T., THE GALAXY TEAM, NEKRUTENKO A., TAYLOR J.: Web-based visual analysis for highthroughput genomics. 397. doi:10.1186/1471-2164-14-397. 2, 10

[GH11] GOLDBERG J., HELFMAN J.: Eye tracking for visualization evaluation: Reading values on linear versus radial graphs. 182–195. doi:10.1177/1473871611406623. 2, 9, 10

[Gle18] GLEICHER M.: Considerations for visualizing comparison. 413– 423. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10.1109/TVCG.2017.2744199. 2, 9, 10

[HB10] HEER J., BOSTOCK M.: Crowdsourcing graphical perception: using mechanical turk to assess visualization design. In Proceedings of the SIGCHI Conference on Human Factors in Computing Systems (2010), CHI ’10, Association for Computing Machinery, pp. 203–212. doi:10.1145/1753326.1753357. 2

[HHA<sup>∗</sup>09] HEINKEN A., HERTEL J., ACHARYA G., RAVCHEEV D. A., NYGA M., OKPALA O. E., HOGAN M., MAGNÚSDÓTTIR S., MAR-TINELLI F., NAP B., PRECIAT G., EDIRISINGHE J. N., HENRY C. S.,

FLEMING R. M. T., THIELE I.: Genome-scale metabolic reconstruction of 7,302 human microorganisms for personalized medicine. 1320– 1331. Number: 9 Publisher: Nature Publishing Group. doi:10.1038/ s41587-022-01628-0. 2

[KAL<sup>∗</sup>] KERPEDJIEV P., ABDENNUR N., LEKSCHAS F., MCCALLUM C., DINKLA K., STROBELT H., LUBER J. M., OUELLETTE S. B., AZHIR A., KUMAR N., HWANG J., LEE S., ALVER B. H., PFISTER H., MIRNY L. A., PARK P. J., GEHLENBORG N.: HiGlass: webbased visual exploration and analysis of genome interaction maps. 125. doi:10.1186/s13059-018-1486-1. 9

[KSB<sup>∗</sup>09] KRZYWINSKI M., SCHEIN J., BIROL , CONNORS J., GAS-COYNE R., HORSMAN D., JONES S. J., MARRA M. A.: Circos: An information aesthetic for comparative genomics. 1639–1645. Company: Cold Spring Harbor Laboratory Press Distributor: Cold Spring Harbor Laboratory Press Institution: Cold Spring Harbor Laboratory Press Label: Cold Spring Harbor Laboratory Press Publisher: Cold Spring Harbor Lab. doi:10.1101/gr.092759.109. 2

[LG22] L’YI S., GEHLENBORG N.: Multi-view design patterns and responsive visualization for genomics data. 1–11. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi: 10.1109/TVCG.2022.3209398. 2, 10

[LJS21] LYI S., JO J., SEO J.: Comparative layouts revisited: Design space, guidelines, and future directions. 1525–1535. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10. 1109/TVCG.2020.3030419. 2, 10

[LKD<sup>∗</sup>23] L’YI S., KELLER M. S., DANDAWATE A., TAING L., CHEN C.-H., BROWN M., MEYER C. A., GEHLENBORG N.: Cistrome Explorer: an interactive visual analysis tool for largescale epigenomic data. Bioinformatics 39, 2 (01 2023). btad018. arXiv:https://academic.oup.com/bioinformatics/ article-pdf/39/2/btad018/49096012/btad018.pdf, doi:10.1093/bioinformatics/btad018. 2

[LKO<sup>∗</sup>13] LEMIEUX J. E., KYES S. A., OTTO T. D., FELLER A. I., EASTMAN R. T., PINCHES R. A., BERRIMAN M., SU X.-Z., NEW-BOLD C. I.: Genome-wide profiling of chromosome interactions in plasmodium falciparum characterizes nuclear architecture and reconfigurations associated with antigenic variation. 519–537. doi:10.1111/ mmi.12381. 10

[LWLG22] L’YI S., WANG Q., LEKSCHAS F., GEHLENBORG N.: Gosling: A grammar-based toolkit for scalable and interactive genomics data visualization. IEEE Transactions on Visualization and Computer Graphics 28, 1 (2022), 140–150. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10.1109/TVCG. 2021.3114876. 1, 2

[MM18] MAÇÃS C., MACHADO P.: Radial calendar of consumption. In 2018 22nd International Conference Information Visualisation (IV) (2018), pp. 96–102. ISSN: 2375-0138. doi:10.1109/iV.2018. 00027. 2

[NHG19] NUSRAT S., HARBIG T., GEHLENBORG N.: Tasks, techniques, and tools for genomic data visualization. 781–805. \_eprint: https://onlinelibrary.wiley.com/doi/pdf/10.1111/cgf.13727. doi:10. 1111/cgf.13727. 1, 2, 4, 9

[OJEF19] ONDOV B., JARDINE N., ELMQVIST N., FRANCONERI S.: Face to face: Evaluating visual comparison. 861–871. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi:10. 1109/TVCG.2018.2864884. 2

[PLW<sup>∗</sup>22] PANDEY A., L’YI S., WANG Q., BORKIN M., GEHLEN-BORG N.: GenoREC: A recommendation system for interactive genomics data visualization. doi:10.31219/osf.io/rscb4. 2

[RFT<sup>∗</sup>13] RUDDLE R. A., FATEEN W., TREANOR D., SONDERGELD P., OUIRKE P.: Leveraging wall-sized high-resolution displays for comparative genomics analyses of copy number variation. IEEE, pp. 89–96. doi:10.1109/BioVis.2013.6664351. 2

[RZZ<sup>∗</sup>13] REBER S., ZHAO Y., ZHANG L., ORLOFF M., ENG C.: Visual analysis of tracts of homozygosity in human genome. 5 pages.

Artwork Size: 5 pages ISBN: 9783905674552 Publisher: The Eurographics Association. doi:10.2312/PE.EUROVAST.EUROVA13. 037-041. 2

[Sti17] STILLWELL J.: The Routledge Handbook of Census Resources, Methods and Applications: Unlocking the UK 2011 Census. Routledge, 2017. Google-Books-ID: 5GcPEAAAQBAJ. 2

[vdBJvW<sup>∗</sup>23] VAN DEN BRANDT A., JONKHEER E. M., VAN WORKUM D.-J. M., VAN DE WETERING H., SMIT S., VILANOVA A.: Panva: Pangenomic variant analysis. IEEE Transactions on Visualization and Computer Graphics (2023), 1–15. doi:10.1109/TVCG.2023. 3282364. 2

[WDG<sup>∗</sup>20] WALDNER M., DIEHL A., GRACANIN <sup>ˇ</sup> D., SPLECHTNA R., DELRIEUX C., MATKOVIC<sup>´</sup> K.: A comparison of radial and linear charts for visualizing daily patterns. 1033–1042. Conference Name: IEEE Transactions on Visualization and Computer Graphics. doi: 10.1109/TVCG.2019.2934784. 2

[ZFAQ13] ZENG W., FU C.-W., ARISONA S. M., QU H.: Visualizing interchange patterns in massive movement data. 271–280. \_eprint: https://onlinelibrary.wiley.com/doi/pdf/10.1111/cgf.12114. doi:10. 1111/cgf.12114. 2